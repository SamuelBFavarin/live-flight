...
- It at least show the: flight identification, aircraft model, origin, destination and speed
- The aircraft model must to be derived from the aircraft's ICAO24 address using a public aircraft registry (e.g. `hexdb.io`); when the registry does not return a match, show `N/A`
